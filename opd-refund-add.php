...
<div class="content-body">
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Add Refund</a></li>
        </ol>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <select class="default-select wide form-control" id="validationCustom03"
                                                    required>
                                                    <option selected disabled value="">Please year
                                                    </option>
                                                    <option value="Male">Years</option>
                                                    <option value="Female">Month</option>
                                                    <option value="Other">Days</option>
                                                    <option value="Other">Hours</option>
                                                </select>
                                                <select class="default-select wide form-control" id="validationCustom03"
                                                    required>
